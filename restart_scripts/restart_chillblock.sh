...
function save_sleep () {
    ...
    sleep $time
    ../exp_rcon_api/say_exp_server.exp $EC_CHILLBLOCK_PASS $EC_CHILLBLOCK_PORT "[WARNING] Server will be restarted today at 23:59"
}



#init
../exp_rcon_api/say_exp_server.exp $EC_CHILLBLOCK_PASS $EC_CHILLBLOCK_PORT "[RESTART] Script successfully started. Server will be restarted tonight."
...
../exp_rcon_api/say_exp_server.exp $EC_CHILLBLOCK_PASS $EC_CHILLBLOCK_PORT "[WARNING] SERVER RESTART! Just reconnect 20 sec after shutdown."
../exp_rcon_api/broadcast_exp_server.exp $EC_CHILLBLOCK_PASS $EC_CHILLBLOCK_PORT "---> SERVER RESTART <---"
#../exp_rcon_api/shtudown_exp_server.exp pw pass "[WARNING] Restarting..."
